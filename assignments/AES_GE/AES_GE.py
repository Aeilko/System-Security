...
for numtraces in [10, 20, 30, 40, 50]:
    ...
    for _ in range(0, 10):
        ...
        for bnum in range(0, 16):
            ...
            for kguess in range(0, 256):
                ...
                for idx, tnum in enumerate(trace_sample):
                    hyp[idx] = HW[intermediate(pt[tnum][bnum], kguess)]
        ...
        print(["%02x"%b for b in bestguess])
    ...
    print(ge_list)
    print("")
    print("Average GE: " + str(sum(ge_list) / len(ge_list)))